...
Your task is to implement the applyFunction method such that it accepts an integer value and a function as parameters, 
...
{
	public static int applyFunction(Integer value,  Function<Integer, Integer> function)
	{
	...
	void main() 
	{
		...
		Function<Integer, Integer> addtion = num -> num + 5;
		
		Function<Integer, Integer> multiply = num -> num *2;
		
		Function<Integer, Integer> subtraction = num -> num - 3;
		
		IO.println("Original value: " + sampleValue);
        IO.println("After adding 5: " + applyFunction(sampleValue, addtion));
        IO.println("After multiplying by 2: " + applyFunction(sampleValue, multiply));
        IO.println("After subtracting 3: " + applyFunction(sampleValue, subtraction));
	}
